...
namespace NewAttendanceProject.Migrations
{
    ...
    [Migration("20250617092651_AddWorkDurationAndIsCompleteToAttendance")]
    partial class AddWorkDurationAndIsCompleteToAttendance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.Attendance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.WorkCalendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.WorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.Attendance", b =>
                {
                    b.HasOne("NewAttendanceProject.Models.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("NewAttendanceProject.Models.Employee", b =>
                {
                    b.HasOne("NewAttendanceProject.Models.Department", "Department")
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewAttendanceProject.Models.WorkSchedule", "WorkSchedule")
                        .WithMany("Employees")
